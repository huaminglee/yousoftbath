...
{
    public partial class PromotionItemAddForm : Form
    {
        //成员变量
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            if (cAllItems.Checked)
            {
                m_Offer = "所有项目";
            }
            else if (cType.Checked)
            {
                if (type.Text == "")
                {
        ...
        {
            menu.Enabled = !cType.Checked;
        }

        //对所有项目打折
        private void cAllItems_CheckedChanged(object sender, EventArgs e)
        {
            cType.Enabled = !cAllItems.Checked;
            type.Enabled = !cAllItems.Checked;
            menu.Enabled = !cAllItems.Checked;
        }
