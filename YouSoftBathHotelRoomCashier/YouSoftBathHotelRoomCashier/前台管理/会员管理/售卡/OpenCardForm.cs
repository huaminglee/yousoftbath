...
namespace YouSoftBathReception
{
    public partial class OpenCardForm : Form
    {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            m_Element.CI_Name = name.Text;
            m_Element.CI_Sexno = gender.Text;
            m_Element.CI_SendCardDate = GeneralClass.Now;
            m_Element.CI_SendCardOperator = LogIn.m_User.id.ToString();
            m_Element.state = "在用";

            if (birthday.Value.ToShortDateString() != GeneralClass.Now.ToShortDateString())
